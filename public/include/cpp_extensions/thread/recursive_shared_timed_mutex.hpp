    ...
    namespace thread
    {
        ...
        public:
            ...
            bool try_lock_for(std::chrono::duration<Rep, Period> const& timeout_duration)
            {
                ...
                return this->lock_track_unique_current_thread([this, &timeout_duration]() { return this->m_lockable.try_lock_for(timeout_duration); });
            }
            ...
            bool try_lock_until(std::chrono::time_point<Clock, Duration> const& timeout_time)
            {
                ...
                return this->lock_track_unique_current_thread([this, &timeout_time]() { return this->m_lockable.try_lock_until(timeout_time); });
            }
